...
export default {
  ...
  methods: {
    saveButton() {
      ...
      if (this.contactData.contactId && this.contactData.firstName && this.contactData.lastName && this.contactData.mobileNo) {
        axios
          .post("http://contact-list-v2-phanuwitsuriya.c9users.io:8081/contact/" + this.$route.params.contactId, editedContact)
          .then(response => {
  ...
  mounted() {
    axios
      .get("http://contact-list-v2-phanuwitsuriya.c9users.io:8081/contact/" + this.$route.params.contactId)
      .then(response => {
